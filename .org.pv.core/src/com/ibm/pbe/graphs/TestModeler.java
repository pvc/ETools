...
public class TestModeler {
	...
	private TestModeler child;
	private List children;
	private List parents;
	private TestModeler parent;
	...
	public TestModeler(Object o) {
		this.value=o;
	}
	
	public void addChild(Object o) {
		TestModeler node=new TestModeler(o);
		addChild(node);
	}
	
	public void addChild(TestModeler node) {
		node.addParent(this);
	 ...
	 * @param gn
	 */
	private void addParent(TestModeler node) {
	 ...
	 */
	public TestModeler getChild() {
		return child;
	}
	/**
	 * @param child The child to set.
	 */
	public void setChild(TestModeler child) {
		this.child = child;
	}
	/**
	 ...
	 */
	public TestModeler getParent() {
		return parent;
	}
	/**
	 * @param parent The parent to set.
	 */
	public void setParent(TestModeler parent) {
		this.parent = parent;
	}
	/**
