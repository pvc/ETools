...
public class PBEDialogOld extends FieldEditorPreferencePage {
...
//		store.setDefault(P_STRING, "Default value");
	...
	public Document execute(Document doc)  {
		...
		if (doc!=null) {
			...
			if ((root!=null) && root.getTagName().equals("properties")) {valid=true;}
		}
		...
		Shell mainShell=new Shell(wbShell, SWT.SHELL_TRIM|SWT.MODELESS);  // = CLOSE, RESIZE, etc
...
//		Composite canvas = getFieldEditorParent(); //should not be cached
